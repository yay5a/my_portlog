...
Looking back, it’s concerning to think how long it took the world to fully grasp the power, and consequences of social media. At the time, we were just riding the wave. *How are things different now with AI?*
...
The best time to start was always then. The second-best time to start is *now*.
