...
This chapter continues **Part 1** (<Link href="/reports/self-hosting-private-server-part-1">SSH + DHCP Reservation</Link>)  
and **Part 2** (<Link href="/reports/self-hosting-private-server-part-2">Caddy Reverse Proxy + IPv6-only Deployment</Link>).
