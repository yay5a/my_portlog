		...
		<>
			...
			<section className="relative py-20 container mx-auto text-center overflow-hidden">
				...
				<p className="mt-4 text-lg relative z-10">
					Looking in from the outside, I exist at the intersection of technology
					and philosophy building reliable and meaningful modern "soulutions" to
					modern questions.
				</p>
			</section>
			<hr />
			...
			<section className="py-12">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					<div className="p-8 rounded-2xl flex flex-col items-center space-y-4 shadow">
						<a href="/contact" className="rounded-full bg-gray-900 p-4">
							<Image src="/self.jpg" alt="Logo" width={40} height={40} />
						</a>
